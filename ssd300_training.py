...
#from ssd_encoder_decoder.ssd_collab_input_encoder import SSDCollabInputEncoder
...
#weights_path = 'saved_weights_orig/ssd300_pascal_07+12_epoch-65_loss-5.6288_val_loss-5.1871.h5'
...
#model_checkpoint = ModelCheckpoint(filepath='saved_weights_orig/ssd300_pascal_07+12_epoch-{epoch:02d}_loss-{loss:.4f}_val_loss-{val_loss:.4f}.h5',
